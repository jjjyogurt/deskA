...
// Keep 20 bytes total for compatibility with default MTU.
constexpr size_t AUDIO_PACKET_TOTAL_BYTES = 20;
...
constexpr int AUDIO_PACKETS_PER_LOOP = 4;
constexpr uint8_t LAST_PACKET_REDUNDANCY = 3; // improve Android finalize reliability
